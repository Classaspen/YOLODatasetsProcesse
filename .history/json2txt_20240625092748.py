...
if __name__ == "__main__":
    json_floder_path = 'C:/Users/username/Desktop/HERO/cam0_sentry_B/label—_json/' #请将json文件的文件夹放在该文件夹下
    txt_outer_path = 'C:/Users/username/Desktop/HERO/cam0_sentry_B/label/' 
